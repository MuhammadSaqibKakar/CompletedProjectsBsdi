                    ...
                    const detailItems = [
                      {
                        ...
                        value: row.district || '-',
                        icon: MapPin,
                        tone: 'from-blue-700 via-sky-700 to-cyan-800',
                      },
                      {
                        label: 'Category',
                        value: row.category || 'Other',
                        icon: Tags,
                        tone: 'from-indigo-700 via-violet-700 to-fuchsia-800',
                      },
                      {
                        label: 'Cost',
                        value: formatCostMillions(row.costMn),
                        icon: CircleDollarSign,
                        tone: 'from-emerald-700 via-teal-700 to-cyan-800',
                      },
                      {
                        label: 'Agency',
                        value: row.executingAgency || '-',
                        icon: Building2,
                        tone: 'from-slate-800 via-blue-900 to-indigo-900',
                      },
                      {
                        label: 'Status',
                        value: row.status || 'Draft',
                        icon: ShieldCheck,
                        tone: 'from-amber-600 via-orange-700 to-rose-800',
                      },
                    ]
                    return (
                      <article key={row.id} className="overflow-hidden rounded-[26px] border border-blue-100 bg-gradient-to-br from-white via-white to-sky-50 shadow-lg shadow-slate-950/10 transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-950/10">
                        <div className="h-1.5 bg-gradient-to-r from-blue-600 via-emerald-500 to-amber-400" />
                        <div className="p-4 sm:p-5">
                          <div className="rounded-3xl border border-blue-100 bg-gradient-to-r from-white via-blue-50/80 to-emerald-50/60 p-4 shadow-sm shadow-blue-950/5">
                            <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                              <div className="flex min-w-0 items-start gap-3">
                                ...
                                <div className="min-w-0">
                                  <h4 className="text-base font-black leading-6 text-slate-950 sm:text-xl">
                                    {row.description || '-'}
                                  </h4>
                              ...
                              <span className={`w-fit shrink-0 rounded-full px-3 py-1.5 text-xs font-black ring-1 ${recommendationClass}`}>
                          ...
                          <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                            {detailItems.map((item) => {
                              ...
                              return (
                                <div
                                  key={item.label}
                                  className={`min-w-0 rounded-2xl bg-gradient-to-br ${item.tone} p-3 text-white shadow-lg shadow-blue-950/15 ring-1 ring-white/10 transition hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-950/20`}
                                >
                          ...
                          {row.sourceRemarks ? (
                            <p className="mt-4 rounded-2xl border border-blue-100 bg-white px-3 py-2 text-sm font-semibold leading-6 text-slate-700 shadow-sm shadow-blue-950/5">
                              {row.sourceRemarks}
                            </p>
                          ) : null}
