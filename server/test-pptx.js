...
export async function testPresentation({ external = false, active = false, tabAligned = false, vectorMedia = false, title = 'Presentation preview check', paddingBytes = 0 } = {}) {
  const zip = new JSZip()
  ...
  if (vectorMedia) zip.file('ppt/media/unsupported-image.emf', 'test vector image')
